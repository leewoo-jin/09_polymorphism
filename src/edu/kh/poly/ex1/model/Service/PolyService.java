...
public class PolyService {
	...
	public void ex1() {
		...
		//상속 + 다형성
		//상속의 특징: Car 상속클래스는 모두 getEngin()을 가지고있다를 정의
...
//          java.lang.ClassCastException
	...
	public void ex5() {
		...
		// String edu.kh.poly.ex1.model.vo.Car.gerEngine()
		
		//프로그램 "실행 전"
		// - 컴파일러는 getEngine() 메소드가 Car에 있는걸로 인식해서
		//c1.getEngine()호풀코드와
		//String edu.kh.poly.ex1.model.vo.Car.gerEngine() 메소드 코드를 연결
		//-> 정적 바인딩
